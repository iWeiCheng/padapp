...
import static com.xjysx.xiaochetong.accessibility.AccessibilityUtil.InputText;
...
//
//        AccessibilityNodeInfo biaoQingInfo3 = findFirst(AbstractTF.newId("com.tencent.mm", "ew1"));
//        if (biaoQingInfo3 != null && !isOk2) {
//            isOk2 = true;
//            Log.e(TAG, "onAccessibilityEvent: 找到wx的注册图标");//可以查看日志
////            biaoQingInfo2.recycle();
//            HongBaoService.clickView(biaoQingInfo3);
//        }
        AccessibilityNodeInfo biaoQingInfo5 = findFirst(AbstractTF.newId("com.tencent.mm", "evv"));
        if (biaoQingInfo5 != null && isOk2) {
            Log.e(TAG, "onAccessibilityEvent: 找到wx的注册图标");//可以查看日志
//            biaoQingInfo2.recycle();
            HongBaoService.clickView(biaoQingInfo5);
        }
        List<AccessibilityNodeInfo> biaoQingInfo4 = findAll(AbstractTF.newId("com.tencent.mm", "bhn"));
        if (biaoQingInfo4.size()>0 && !isOk) {
            isOk = true;
            Log.e(TAG, "onAccessibilityEvent: 找到请填写手机号");//可以查看日志
//            biaoQingInfo2.recycle();
            InputText(HongBaoService.mService,biaoQingInfo4.get(0),"无邪");
            InputText(HongBaoService.mService,biaoQingInfo4.get(1),"13631326632");
            InputText(HongBaoService.mService,biaoQingInfo4.get(2),"ggggm12345");
        }
    }
